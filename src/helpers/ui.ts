...
export const getLogoElement = (): Element => {
  ...
  p1.setAttribute(
    'points',
    '501.45 0 207.71 0 0 207.71 0 501.45 207.71 709.16 501.45 709.16 709.16 501.45 709.16 207.71 501.45 0',
  )
  p1.setAttribute('fill', '#88181a')
  p2.setAttribute(
    'points',
    '1282.93 131.04 1150.56 0 646.02 0 778.38 131.04 915.5 131.04 915.5 709.16 1046.54 576.8 1046.54 131.04 1282.93 131.04',
  )
...
export const createScriptElmt = (url: string) => {
  const element: Element = document.createElement('script')
